<template>
    <n-modal
        ...
        size="huge"
    >
        <template #header>NP_046553.1</template>
        ...
        <div class="flex flex-row text-xl">
            <p class="mr-3 font-bold">OStart:</p>
            {{ Number(selectProteinData.start_point) }}
        </div>
        <div class="flex flex-row text-xl">
            <p class="mr-3 font-bold">Stop:</p>
            {{ Number(selectProteinData.end_point) }}
        </div>
        <div class="flex flex-row text-xl">
        ...
        <div class="flex flex-row text-xl">
            ...
            {{ selectProteinData.protein_sort_class }}
        </div>
        <div class="flex flex-row text-xl">
        ...
        <div class="font-mono mt-2">{{ selectProteinData.protein_sequence }}</div>
    </n-modal>
    ...
    <div class="flex flex-row bg-gray-50 w-310 h-28">
        ...
        <div class="text-3xl font-800 ml-7 mt-10">{{ title }}</div>
